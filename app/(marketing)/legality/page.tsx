    ...
    <div className="min-h-screen bg-slate-50 pt-32 pb-20 px-6">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid gap-6">
          {legalityData.map((item, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 flex flex-col md:flex-row md:items-center gap-6 group hover:border-blue-300 transition-all"
            >
              <div className="text-4xl bg-slate-50 w-20 h-20 flex items-center justify-center rounded-2xl group-hover:bg-blue-50 transition-colors">
                {item.icon}
              </div>
              <div className="grow">
                ...
                <p className="text-blue-600 font-medium mb-2">{item.detail}</p>
        ...
        <motion.div
          ...
          className="mt-16 p-8 bg-blue-600 rounded-3xl text-white text-center shadow-xl shadow-blue-100"
        >
          ...
          <p className="text-blue-100 text-sm">
            ...
            Indonesia untuk memberikan keamanan maksimal bagi setiap klien kami.
          </p>
        </motion.div>
      </div>
    </div>
